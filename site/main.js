...
(function($){
  ...
  $(document).ready(function(){
	...
	// add edges in this manner because it is easy with the format we have as output files
	sys.addEdge('Computer','Optical disc')
	sys.addEdge('Computer','Personal digital assistant')
	sys.addEdge('Computer','Fortran')
	sys.addEdge('Fortran','Address programming language')
